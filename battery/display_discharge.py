...
def start_tray_icon():
    ...
    menu = pystray.Menu(pystray.MenuItem('Stop monitoring', lambda: stop_monitoring(icon)))
    
    icon = pystray.Icon("Battery Monitor", menu=menu)
    icon.icon = create_image(64, 64, 0, "black")
