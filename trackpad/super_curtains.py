...
def create_super_curtains_window():
    ...
    fig, ax = plt.subplots(figsize=(ui_style.window_width / 200, ui_style.window_height / 300))
    ...
    slider_top = ttk.Scale(sub_window, from_=0, to=MAX_SUPER_CURTAIN_TOP_BOTTOM_CM, orient='horizontal', length=ui_style.slider_length, 
    ...
    slider_bottom = ttk.Scale(sub_window, from_=0, to=MAX_SUPER_CURTAIN_TOP_BOTTOM_CM, orient='horizontal', length=ui_style.slider_length, 
    ...
    slider_left = ttk.Scale(sub_window, from_=0, to=MAX_SUPER_CURTAIN_LEFT_RIGHT_CM, orient='horizontal', length=ui_style.slider_length, 
    ...
    slider_right = ttk.Scale(sub_window, from_=0, to=MAX_SUPER_CURTAIN_LEFT_RIGHT_CM, orient='horizontal', length=ui_style.slider_length, 
